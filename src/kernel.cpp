...
int nStakeTargetSpacing = 5 * 60; // Fibercoin: 5 minute blocks during POS (block 201+)
...
{
    // Fibercoin will hash in the transaction hash and the index number in order to make sure each hash is unique
