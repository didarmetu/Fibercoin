...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fibercoin features */
        {"hidden", "masternode", &masternode, true, true, false},
        {"network-wide masternode", "listmasternodes", &listmasternodes, true, true, false},
        {"network-wide masternode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hidden", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hidden", "masternodecurrent", &masternodecurrent, true, true, false},
        {"legacy single-masternode", "masternodedebug", &masternodedebug, true, true, false},
        {"hidden", "startmasternode", &startmasternode, true, true, true},
        {"hidden", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hidden", "getmasternodeoutputs", &getmasternodeoutputs, true, true, true},
        {"hidden", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"legacy single-masternode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"multimaster host", "multimasterstatus", &multimasterstatus, true, true, false},
        {"hidden", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hidden", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fibercoin", "mnbudget", &mnbudget, true, true, false},
        {"fibercoin", "preparebudget", &preparebudget, true, true, true},
        {"fibercoin", "submitbudget", &submitbudget, true, true, false},
        {"fibercoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fibercoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fibercoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fibercoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fibercoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fibercoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fibercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fibercoin", "checkbudgets", &checkbudgets, true, true, false},
        {"network-wide masternode", "mnsync", &mnsync, true, true, false},
        {"fibercoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> fibercoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33114/\n";
}
