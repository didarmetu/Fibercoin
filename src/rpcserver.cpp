...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fibercoin features */
        {"fibercoin", "masternode", &masternode, true, true, false},
        {"fibercoin", "listmasternodes", &listmasternodes, true, true, false},
        {"fibercoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fibercoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fibercoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fibercoin", "masternodedebug", &masternodedebug, true, true, false},
        {"fibercoin", "startmasternode", &startmasternode, true, true, false},
        {"fibercoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fibercoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        ...
        {"fibercoin", "preparebudget", &preparebudget, true, true, false},
        ...
        {"fibercoin", "mnsync", &mnsync, true, true, false},
