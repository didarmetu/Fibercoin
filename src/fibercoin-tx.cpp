...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Fibercoin fibercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fibercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fibercoin transaction") + "\n" +
                               "  fibercoin-tx [options] -create [commands]   " + _("Create hex-encoded fibercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fibercoin transaction
