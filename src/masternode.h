...
#define MASTERNODE_MIN_CONFIRMATIONS 7   //Masternode  min confirmation
...
#define MASTERNODE_COLLATERAL 10000  // Masternode collateral = 10,000 FBC
...
//
// The Masternode Class. It contains the input of the FBC collateral, signature to prove
