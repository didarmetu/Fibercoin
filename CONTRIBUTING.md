...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the fibercoin unit tests or QA tests
...
The following applies to code changes to the Fibercoin project, and is not to be
confused with overall Fibercoin Network Protocol consensus changes.

Whether a pull request is merged into Fibercoin rests with the project merge
...
Patches that change Fibercoin consensus rules are considerably more involved than
...
The project leader is the release manager for each Fibercoin release.
