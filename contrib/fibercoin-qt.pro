...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/fibercoin-cli.cpp \
           src/fibercoin-tx.cpp \
           src/fibercoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/fibercoin.qrc src/qt/fibercoin_locale.qrc

TRANSLATIONS += src/qt/locale/fibercoin_bg.ts \
                src/qt/locale/fibercoin_de.ts \
                src/qt/locale/fibercoin_en.ts \
                src/qt/locale/fibercoin_es.ts \
                src/qt/locale/fibercoin_fi.ts \
                src/qt/locale/fibercoin_fr.ts \
                src/qt/locale/fibercoin_it.ts \
                src/qt/locale/fibercoin_ja.ts \
                src/qt/locale/fibercoin_pl.ts \
                src/qt/locale/fibercoin_pt.ts \
                src/qt/locale/fibercoin_ru.ts \
                src/qt/locale/fibercoin_sk.ts \
                src/qt/locale/fibercoin_sv.ts \
                src/qt/locale/fibercoin_vi.ts \
                src/qt/locale/fibercoin_zh_CN.ts \
                src/qt/locale/fibercoin_zh_TW.ts
