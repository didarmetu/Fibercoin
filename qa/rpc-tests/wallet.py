...
#   c) node1 mines 32 blocks, so now node 0 has 500000FBC, node 1 has 4250FBC, node2 has none.
#   d) node0 sends 601 FBC to node2, in two transactions (301 FBC, then 300 FBC).
