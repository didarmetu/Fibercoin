...
In order to support loading of multiple wallets in fibercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fibercoin.cpp.
...
Changes to fibercoin.cpp
----------------------
fibercoin.cpp is the entry point into fibercoin-qt, and as such, will require some minor modifications to provide hooks for
